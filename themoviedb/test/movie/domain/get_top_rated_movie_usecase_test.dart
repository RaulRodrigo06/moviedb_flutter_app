...
void main() {
  late GetTopRatedMovieUsecase usecase;
  late IMovieRepository repository;

  setUp(() {
    repository = MockMovieRepository();
    usecase = GetTopRatedMovieUsecase(repository: repository);
  });
  ...
  test('should get ListMovieEntity for a given date from the repository',
    ...
    verify(() => repository.getTopRatedMovieList(page: 1)).called(1);
  });

  test('should return a error when don\'t succeed', () async {
    when(() => repository.getTopRatedMovieList(page: 1)).thenAnswer(
